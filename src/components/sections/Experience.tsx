    ...
    <section id="experience" className="py-24 px-4 overflow-hidden bg-background">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary/10 text-secondary text-xs font-bold uppercase tracking-widest mb-4 border border-secondary/20">
        ...
        <div className="relative">
          ...
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-primary via-secondary to-transparent md:translate-x-[-0.5px] opacity-30" />
          ...
          <div className="space-y-16">
            {EXPERIENCE.map((exp, i) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-4 md:left-1/2 w-4 h-4 rounded-full bg-background border-2 border-secondary z-10 translate-x-[-7.5px] md:translate-x-[-7.5px] group-hover:scale-125 transition-all duration-300 group-hover:bg-secondary group-hover:shadow-[0_0_15px_rgba(var(--secondary),0.5)]" />
                ...
                <div className={cn(
                  ...
                  <div className="sticky top-24">
                    <span className="inline-flex items-center gap-2 text-sm font-bold text-secondary bg-secondary/5 px-4 py-2 rounded-full border border-secondary/20 shadow-sm">
                ...
                <div className="w-full md:w-1/2 pl-12 md:pl-0">
                  <div className={cn(
                    ...
                    hoveredIndex === i ? "border-secondary/50 shadow-2xl shadow-secondary/5 -translate-y-2" : "border-border/40 hover:border-border"
                  )}>
                    {/* Decorative Gradient */}
                    ...
                    <div className="relative z-10 space-y-4">
                      <div className="flex flex-col gap-1">
                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-secondary">{exp.role}</span>
                      ...
                      <div className={cn(
                        ...
                        <div className="overflow-hidden space-y-4">
                          <h4 className="text-[10px] font-bold uppercase tracking-widest text-secondary/80">Key Contributions</h4>
                          <div className="space-y-3">
                            {exp.highlights?.map((highlight, j) => (
                              <div key={j} className="flex gap-3 text-xs leading-relaxed text-foreground/80 group/item">
                                <ChevronRight className="h-4 w-4 shrink-0 text-secondary transition-transform group-hover/item:translate-x-1" />
                                <span>{highlight}</span>
                              </div>
                            ))}
                          </div>
                      ...
                      <div className={cn(
                        "pt-2 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-secondary/50 transition-opacity duration-300",
                        hoveredIndex === i ? "opacity-0" : "opacity-100"
                      )}>
                        <span className="w-2 h-2 rounded-full bg-secondary animate-pulse" />
                        Hover to explore impact
                      </div>
                    </div>
                  </div>
                </div>
